...
class Instructor extends Person {
  constructor (lastName, firstName, school, dateOfBirth, username) {
    ...
    this.course_list = []
    console.log("Instructor Constructor called. course_list initialized:", this.course_list); 
    this.courseList = this.course_list; //added this to explicitly set this.courseList because i was getting an error with TypeError: Cannot read properties of undefined (reading 'push') when assigning instructor to a course 
  }
